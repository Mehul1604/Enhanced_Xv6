...
main(void)
{
  ...
  1d:	e8 79 03 00 00       	call   39b <open>
  ...
  30:	6a 00                	push   $0x0
  32:	e8 9c 03 00 00       	call   3d3 <dup>
  dup(0);  // stderr
  37:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3e:	e8 90 03 00 00       	call   3d3 <dup>
  ...
  b0:	e8 de 02 00 00       	call   393 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  d2:	e8 cc 02 00 00       	call   3a3 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 28 08 00 00       	push   $0x828
  e0:	e8 b6 02 00 00       	call   39b <open>
 ...
 219:	31 f6                	xor    %esi,%esi
{
 ...
 238:	50                   	push   %eax
 239:	6a 00                	push   $0x0
 23b:	e8 33 01 00 00       	call   373 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2a1:	e8 f5 00 00 00       	call   39b <open>
  if(fd < 0)
 ...
 2b5:	50                   	push   %eax
 2b6:	e8 f8 00 00 00       	call   3b3 <fstat>
  close(fd);
 2bb:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2be:	89 c6                	mov    %eax,%esi
  close(fd);
 2c0:	e8 be 00 00 00       	call   383 <close>
  return r;
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 e6 fe ff ff       	call   37b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 509:	e8 6d fe ff ff       	call   37b <write>
 ...
 569:	e8 0d fe ff ff       	call   37b <write>
        putc(fd, c);
      } else {
 ...
 57d:	e8 f9 fd ff ff       	call   37b <write>
  for(i = 0; fmt[i]; i++){
 ...
 5f1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5f4:	e8 82 fd ff ff       	call   37b <write>
        ap++;
 ...
 66b:	57                   	push   %edi
 66c:	53                   	push   %ebx
 66d:	e8 09 fd ff ff       	call   37b <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 78b:	e8 53 fc ff ff       	call   3e3 <sbrk>
  if(p == (char*)-1)
