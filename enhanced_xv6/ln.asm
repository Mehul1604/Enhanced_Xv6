   ...
   e:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  36:	e8 f0 02 00 00       	call   32b <link>
 ...
 189:	31 f6                	xor    %esi,%esi
{
 ...
 1a8:	50                   	push   %eax
 1a9:	6a 00                	push   $0x0
 1ab:	e8 33 01 00 00       	call   2e3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 211:	e8 f5 00 00 00       	call   30b <open>
  if(fd < 0)
 ...
 225:	50                   	push   %eax
 226:	e8 f8 00 00 00       	call   323 <fstat>
  close(fd);
 22b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22e:	89 c6                	mov    %eax,%esi
  close(fd);
 230:	e8 be 00 00 00       	call   2f3 <close>
  return r;
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3fe:	56                   	push   %esi
 3ff:	57                   	push   %edi
 400:	e8 e6 fe ff ff       	call   2eb <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 479:	e8 6d fe ff ff       	call   2eb <write>
 ...
 4d9:	e8 0d fe ff ff       	call   2eb <write>
        putc(fd, c);
      } else {
 ...
 4ed:	e8 f9 fd ff ff       	call   2eb <write>
  for(i = 0; fmt[i]; i++){
 ...
 561:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 564:	e8 82 fd ff ff       	call   2eb <write>
        ap++;
 ...
 5db:	57                   	push   %edi
 5dc:	53                   	push   %ebx
 5dd:	e8 09 fd ff ff       	call   2eb <write>
        while(*s != 0){
