...
main(int argc, char *argv[])
{
  ...
  59:	e8 c5 03 00 00       	call   423 <close>
  for(i = 1; i < argc; i++){
  ...
  aa:	31 db                	xor    %ebx,%ebx
{
  ...
  d8:	e8 36 03 00 00       	call   413 <read>
 ...
 2b9:	31 f6                	xor    %esi,%esi
{
 ...
 2d8:	50                   	push   %eax
 2d9:	6a 00                	push   $0x0
 2db:	e8 33 01 00 00       	call   413 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 341:	e8 f5 00 00 00       	call   43b <open>
  if(fd < 0)
 ...
 355:	50                   	push   %eax
 356:	e8 f8 00 00 00       	call   453 <fstat>
  close(fd);
 35b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 35e:	89 c6                	mov    %eax,%esi
  close(fd);
 360:	e8 be 00 00 00       	call   423 <close>
  return r;
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 52e:	56                   	push   %esi
 52f:	57                   	push   %edi
 530:	e8 e6 fe ff ff       	call   41b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a9:	e8 6d fe ff ff       	call   41b <write>
 ...
 609:	e8 0d fe ff ff       	call   41b <write>
        putc(fd, c);
      } else {
 ...
 61d:	e8 f9 fd ff ff       	call   41b <write>
  for(i = 0; fmt[i]; i++){
 ...
 691:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 694:	e8 82 fd ff ff       	call   41b <write>
        ap++;
 ...
 70b:	57                   	push   %edi
 70c:	53                   	push   %ebx
 70d:	e8 09 fd ff ff       	call   41b <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 82b:	e8 53 fc ff ff       	call   483 <sbrk>
  if(p == (char*)-1)
