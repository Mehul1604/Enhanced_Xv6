...
int main(int argc, char *argv[])
{
  ...
  16:	a1 08 0b 00 00       	mov    0xb08,%eax
  1b:	85 c0                	test   %eax,%eax
  1d:	7e 51                	jle    70 <main+0x70>
  1f:	31 db                	xor    %ebx,%ebx
  21:	eb 27                	jmp    4a <main+0x4a>
  ...
  2d:	50                   	push   %eax
  2e:	8d 04 9b             	lea    (%ebx,%ebx,4),%eax
  for (j = 0; j < number_of_processes; j++)
  31:	83 c3 01             	add    $0x1,%ebx
       set_priority(100-(20+(j*5)),pid); // will only matter for PBS, comment it out if not implemented yet (better priorty for more IO intensive jobs)
  34:	f7 d8                	neg    %eax
  36:	83 c0 50             	add    $0x50,%eax
  39:	50                   	push   %eax
  3a:	e8 dc 03 00 00       	call   41b <set_priority>
  3f:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  42:	39 1d 08 0b 00 00    	cmp    %ebx,0xb08
  48:	7e 26                	jle    70 <main+0x70>
    int pid = fork();
  4a:	e8 1c 03 00 00       	call   36b <fork>
    if (pid < 0)
  4f:	85 c0                	test   %eax,%eax
  51:	79 d5                	jns    28 <main+0x28>
      printf(1, "Fork failed\n");
  ...
  for (j = 0; j < number_of_processes; j++)
  68:	39 1d 08 0b 00 00    	cmp    %ebx,0xb08
  6e:	7f da                	jg     4a <main+0x4a>
    }
  }
  for (j = 0; j < number_of_processes+5; j++)
  70:	83 3d 08 0b 00 00 fc 	cmpl   $0xfffffffc,0xb08
  77:	7c 1b                	jl     94 <main+0x94>
  79:	31 db                	xor    %ebx,%ebx
 ...
 239:	31 f6                	xor    %esi,%esi
{
 ...
 258:	50                   	push   %eax
 259:	6a 00                	push   $0x0
 25b:	e8 33 01 00 00       	call   393 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2c1:	e8 f5 00 00 00       	call   3bb <open>
  if(fd < 0)
 ...
 2d5:	50                   	push   %eax
 2d6:	e8 f8 00 00 00       	call   3d3 <fstat>
  close(fd);
 2db:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2de:	89 c6                	mov    %eax,%esi
  close(fd);
 2e0:	e8 be 00 00 00       	call   3a3 <close>
  return r;
...
printf(int fd, const char *fmt, ...)
{
 ...
 529:	e8 6d fe ff ff       	call   39b <write>
 ...
 589:	e8 0d fe ff ff       	call   39b <write>
        putc(fd, c);
      } else {
 ...
 59d:	e8 f9 fd ff ff       	call   39b <write>
  for(i = 0; fmt[i]; i++){
 ...
 611:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 614:	e8 82 fd ff ff       	call   39b <write>
        ap++;
 ...
 664:	eb 1a                	jmp    680 <printf+0x1a0>
          s = "(null)";
 666:	bb 55 08 00 00       	mov    $0x855,%ebx
        while(*s != 0){
 ...
 68b:	57                   	push   %edi
 68c:	53                   	push   %ebx
 68d:	e8 09 fd ff ff       	call   39b <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b5:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 6d6:	73 10                	jae    6e8 <free+0x38>
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 707:	5e                   	pop    %esi
 708:	5f                   	pop    %edi
 709:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 74d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 750:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 799:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 7ab:	e8 53 fc ff ff       	call   403 <sbrk>
  if(p == (char*)-1)
 ...
 7c2:	e8 e9 fe ff ff       	call   6b0 <free>
  return freep;
 7c7:	a1 0c 0b 00 00       	mov    0xb0c,%eax
 ...
 7f4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7f7:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 ...
 80e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 817:	0b 00 00 
    base.s.size = 0;
 81a:	bf 10 0b 00 00       	mov    $0xb10,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 826:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 829:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 82b:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 832:	00 00 00 
    if(p->s.size >= nunits){
