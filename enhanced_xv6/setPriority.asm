  ...
  17:	83 39 03             	cmpl   $0x3,(%ecx)
{
  1a:	8b 59 04             	mov    0x4(%ecx),%ebx
	if(!(argc == 3))
  1d:	74 1f                	je     3e <main+0x3e>
	{
		printf(1 , "Invalid arguments\n");
  1f:	83 ec 08             	sub    $0x8,%esp
  22:	68 b8 07 00 00       	push   $0x7b8
  27:	6a 01                	push   $0x1
  29:	e8 22 04 00 00       	call   450 <printf>
  ...
  41:	ff 73 04             	pushl  0x4(%ebx)
  44:	e8 27 02 00 00       	call   270 <atoi>
  ...
  57:	89 c3                	mov    %eax,%ebx
	if(set_priority(newp , pid) > 0)
  59:	56                   	push   %esi
  5a:	e8 2c 03 00 00       	call   38b <set_priority>
  5f:	83 c4 10             	add    $0x10,%esp
  62:	85 c0                	test   %eax,%eax
  64:	7e 11                	jle    77 <main+0x77>
		printf(1 , "Priority of process %d changed to %d\n" , pid , newp);
  66:	56                   	push   %esi
  67:	53                   	push   %ebx
  68:	68 cc 07 00 00       	push   $0x7cc
  6d:	6a 01                	push   $0x1
  6f:	e8 dc 03 00 00       	call   450 <printf>
  74:	83 c4 10             	add    $0x10,%esp
	exit();
  77:	e8 67 02 00 00       	call   2e3 <exit>
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 f6                	xor    %esi,%esi
{
 ...
 1c8:	50                   	push   %eax
 1c9:	6a 00                	push   $0x0
 1cb:	e8 33 01 00 00       	call   303 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 231:	e8 f5 00 00 00       	call   32b <open>
  if(fd < 0)
 ...
 245:	50                   	push   %eax
 246:	e8 f8 00 00 00       	call   343 <fstat>
  close(fd);
 24b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 24e:	89 c6                	mov    %eax,%esi
  close(fd);
 250:	e8 be 00 00 00       	call   313 <close>
  return r;
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 41e:	56                   	push   %esi
 41f:	57                   	push   %edi
 420:	e8 e6 fe ff ff       	call   30b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 499:	e8 6d fe ff ff       	call   30b <write>
 ...
 4f9:	e8 0d fe ff ff       	call   30b <write>
        putc(fd, c);
      } else {
 ...
 50d:	e8 f9 fd ff ff       	call   30b <write>
  for(i = 0; fmt[i]; i++){
 ...
 581:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 584:	e8 82 fd ff ff       	call   30b <write>
        ap++;
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb f2 07 00 00       	mov    $0x7f2,%ebx
        while(*s != 0){
 ...
 5fb:	57                   	push   %edi
 5fc:	53                   	push   %ebx
 5fd:	e8 09 fd ff ff       	call   30b <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
 ...
 71b:	e8 53 fc ff ff       	call   373 <sbrk>
  if(p == (char*)-1)
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 c0 0a 00 00       	mov    0xac0,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 ...
 77e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 c0 0a 00 00 c4 	movl   $0xac4,0xac0
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf c4 0a 00 00       	mov    $0xac4,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79b:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 7a2:	00 00 00 
    if(p->s.size >= nunits){
