...
main(void)
{
  ...
  21:	6a 05                	push   $0x5
  23:	e8 03 03 00 00       	call   32b <sleep>
 ...
 159:	31 f6                	xor    %esi,%esi
{
 ...
 178:	50                   	push   %eax
 179:	6a 00                	push   $0x0
 17b:	e8 33 01 00 00       	call   2b3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1e1:	e8 f5 00 00 00       	call   2db <open>
  if(fd < 0)
 ...
 1f5:	50                   	push   %eax
 1f6:	e8 f8 00 00 00       	call   2f3 <fstat>
  close(fd);
 1fb:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1fe:	89 c6                	mov    %eax,%esi
  close(fd);
 200:	e8 be 00 00 00       	call   2c3 <close>
  return r;
 ...
 35c:	89 d1                	mov    %edx,%ecx
{
 ...
 3ce:	56                   	push   %esi
 3cf:	57                   	push   %edi
 3d0:	e8 e6 fe ff ff       	call   2bb <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 449:	e8 6d fe ff ff       	call   2bb <write>
 ...
 4a9:	e8 0d fe ff ff       	call   2bb <write>
        putc(fd, c);
      } else {
 ...
 4bd:	e8 f9 fd ff ff       	call   2bb <write>
  for(i = 0; fmt[i]; i++){
 ...
 531:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 534:	e8 82 fd ff ff       	call   2bb <write>
        ap++;
 ...
 5ab:	57                   	push   %edi
 5ac:	53                   	push   %ebx
 5ad:	e8 09 fd ff ff       	call   2bb <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6cb:	e8 53 fc ff ff       	call   323 <sbrk>
  if(p == (char*)-1)
