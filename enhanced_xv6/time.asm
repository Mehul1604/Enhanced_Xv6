...
int main(int argc , char *argv[])
{
  ...
  16:	8b 59 04             	mov    0x4(%ecx),%ebx
	int pid = fork();
  19:	e8 cd 02 00 00       	call   2eb <fork>
	if(pid < 0)
  1e:	85 c0                	test   %eax,%eax
  20:	78 57                	js     79 <main+0x79>
		printf(1 , "Forking error!\n");

	else if(pid == 0)
  22:	74 2b                	je     4f <main+0x4f>
		}
	}
	else if(pid > 0)
	{
  ...
  2d:	50                   	push   %eax
  2e:	e8 d0 02 00 00       	call   303 <waitx>
		printf(1, "Process %d exited with waiting time %d and run time %d\n" ,cpid ,  WTIME,RTIME);
  33:	5a                   	pop    %edx
  34:	ff 75 f4             	pushl  -0xc(%ebp)
  37:	ff 75 f0             	pushl  -0x10(%ebp)
  3a:	50                   	push   %eax
  3b:	68 ec 07 00 00       	push   $0x7ec
  40:	6a 01                	push   $0x1
  42:	e8 19 04 00 00       	call   460 <printf>
  47:	83 c4 20             	add    $0x20,%esp
	}
  ...
  4f:	50                   	push   %eax
  50:	50                   	push   %eax
  51:	8d 43 04             	lea    0x4(%ebx),%eax
  54:	50                   	push   %eax
  55:	ff 73 04             	pushl  0x4(%ebx)
  58:	e8 d6 02 00 00       	call   333 <exec>
  5d:	83 c4 10             	add    $0x10,%esp
  60:	85 c0                	test   %eax,%eax
  62:	79 e6                	jns    4a <main+0x4a>
			printf(1 , "Exec for %s failed\n" , argv[1]);
  64:	51                   	push   %ecx
  65:	ff 73 04             	pushl  0x4(%ebx)
  68:	68 d8 07 00 00       	push   $0x7d8
  6d:	6a 01                	push   $0x1
  ...
  79:	50                   	push   %eax
  7a:	50                   	push   %eax
  7b:	68 c8 07 00 00       	push   $0x7c8
  80:	6a 01                	push   $0x1
  82:	e8 d9 03 00 00       	call   460 <printf>
  87:	83 c4 10             	add    $0x10,%esp
  8a:	eb be                	jmp    4a <main+0x4a>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
 ...
 1b9:	31 f6                	xor    %esi,%esi
{
 ...
 1d8:	50                   	push   %eax
 1d9:	6a 00                	push   $0x0
 1db:	e8 33 01 00 00       	call   313 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 241:	e8 f5 00 00 00       	call   33b <open>
  if(fd < 0)
 ...
 255:	50                   	push   %eax
 256:	e8 f8 00 00 00       	call   353 <fstat>
  close(fd);
 25b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 25e:	89 c6                	mov    %eax,%esi
  close(fd);
 260:	e8 be 00 00 00       	call   323 <close>
  return r;
 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 42e:	56                   	push   %esi
 42f:	57                   	push   %edi
 430:	e8 e6 fe ff ff       	call   31b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 4a9:	e8 6d fe ff ff       	call   31b <write>
 ...
 509:	e8 0d fe ff ff       	call   31b <write>
        putc(fd, c);
      } else {
 ...
 51d:	e8 f9 fd ff ff       	call   31b <write>
  for(i = 0; fmt[i]; i++){
 ...
 591:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 594:	e8 82 fd ff ff       	call   31b <write>
        ap++;
 ...
 60b:	57                   	push   %edi
 60c:	53                   	push   %ebx
 60d:	e8 09 fd ff ff       	call   31b <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 d8 0a 00 00       	mov    %eax,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
 ...
 72b:	e8 53 fc ff ff       	call   383 <sbrk>
  if(p == (char*)-1)
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 d8 0a 00 00       	mov    0xad8,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 ...
 78e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf dc 0a 00 00       	mov    $0xadc,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 7b2:	00 00 00 
    if(p->s.size >= nunits){
