...
00000100 <ls>:
{
 ...
 113:	6a 00                	push   $0x0
 115:	57                   	push   %edi
 116:	e8 d0 04 00 00       	call   5eb <open>
 ...
 131:	56                   	push   %esi
 132:	50                   	push   %eax
 133:	e8 cb 04 00 00       	call   603 <fstat>
 ...
 159:	53                   	push   %ebx
 15a:	e8 74 04 00 00       	call   5d3 <close>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 b1 03 00 00       	call   5c3 <read>
 ...
 313:	e8 bb 02 00 00       	call   5d3 <close>
    return;
 ...
 469:	31 f6                	xor    %esi,%esi
{
 ...
 488:	50                   	push   %eax
 489:	6a 00                	push   $0x0
 48b:	e8 33 01 00 00       	call   5c3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4f1:	e8 f5 00 00 00       	call   5eb <open>
  if(fd < 0)
 ...
 505:	50                   	push   %eax
 506:	e8 f8 00 00 00       	call   603 <fstat>
  close(fd);
 50b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 50e:	89 c6                	mov    %eax,%esi
  close(fd);
 510:	e8 be 00 00 00       	call   5d3 <close>
  return r;
 ...
 66c:	89 d1                	mov    %edx,%ecx
{
 ...
 6de:	56                   	push   %esi
 6df:	57                   	push   %edi
 6e0:	e8 e6 fe ff ff       	call   5cb <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 759:	e8 6d fe ff ff       	call   5cb <write>
 ...
 7b9:	e8 0d fe ff ff       	call   5cb <write>
        putc(fd, c);
      } else {
 ...
 7cd:	e8 f9 fd ff ff       	call   5cb <write>
  for(i = 0; fmt[i]; i++){
 ...
 841:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 844:	e8 82 fd ff ff       	call   5cb <write>
        ap++;
 ...
 8bb:	57                   	push   %edi
 8bc:	53                   	push   %ebx
 8bd:	e8 09 fd ff ff       	call   5cb <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 9db:	e8 53 fc ff ff       	call   633 <sbrk>
  if(p == (char*)-1)
