...
00000020 <printf>:
{
  ...
  3c:	e8 9a 03 00 00       	call   3db <write>
}
  ...
  58:	31 db                	xor    %ebx,%ebx
{
  ...
  70:	6a 01                	push   $0x1
  72:	e8 64 03 00 00       	call   3db <write>
  ...
  ce:	6a 01                	push   $0x1
  d0:	e8 06 03 00 00       	call   3db <write>
}
  ...
  f5:	6a 01                	push   $0x1
  f7:	e8 df 02 00 00       	call   3db <write>
      exit();
 ...
 117:	6a 01                	push   $0x1
 119:	e8 bd 02 00 00       	call   3db <write>
    exit();
 ...
 139:	6a 01                	push   $0x1
 13b:	e8 9b 02 00 00       	call   3db <write>
    exit();
 ...
 279:	31 f6                	xor    %esi,%esi
{
 ...
 298:	50                   	push   %eax
 299:	6a 00                	push   $0x0
 29b:	e8 33 01 00 00       	call   3d3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 301:	e8 f5 00 00 00       	call   3fb <open>
  if(fd < 0)
 ...
 315:	50                   	push   %eax
 316:	e8 f8 00 00 00       	call   413 <fstat>
  close(fd);
 31b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 31e:	89 c6                	mov    %eax,%esi
  close(fd);
 320:	e8 be 00 00 00       	call   3e3 <close>
  return r;
